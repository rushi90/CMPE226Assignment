...
<h1 align="center">Nail Polish Details</h1>
	<table align="center" width="100%" border="">
		...
		<%
			if (request.getAttribute("nailpolishDAO") != null) {
				ArrayList<NailPolishDao> book = (ArrayList) request
						.getAttribute("nailpolishDAO");
				...
				for (int i = 0; i < book.size(); i++) {
					...
					out.print("<form action=\"NailPolishDetailsServlet\"><input type=\"hidden\" name=\"Details_NailPolish\" value=\""+book.get(i).getProduct_id()+"\">");
